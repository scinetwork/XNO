...
class SpectralConvFourier(BaseSpectralConv):
...
class SpectralConvFourier1d(SpectralConvFourier):
    """1D Spectral Conv
...
class SpectralConvFourier2d(SpectralConvFourier):
...
class SpectralConvFourier3d(SpectralConvFourier):
