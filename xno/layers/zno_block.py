...
from .spectral_convolution_Z import SpectralConv
...
class ZNOBlocks(nn.Module):
    """ZNOBlocks implements a sequence of Fourier layers, the operations of which 
    ...
    ~~ preactivation : bool, optional
        ...
        if False, call activation and norms after Fourier ada_in_featuresconvolutions
