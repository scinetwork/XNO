...
from xno.layers.spectral_convolution_fourier import (SpectralConvFourier3d, SpectralConvFourier2d,
                                       SpectralConvFourier1d, SpectralConvFourier)
...
def test_SpectralConv(factorization, implementation, separable, dim, complex_data):
    ...
    conv_dense = SpectralConvFourier(
        3, 3, modes[:dim],
        bias=False,
...
def test_SpectralConv3D(factorization, implementation):
    ...
    conv_dense = SpectralConvFourier3d(
...
def test_SpectralConv2D(factorization, implementation):
    ...
    conv_dense = SpectralConvFourier2d(
...
def test_SpectralConv1D(factorization, implementation):
    ...
    conv_dense = SpectralConvFourier1d(
