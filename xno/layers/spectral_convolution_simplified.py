...
class SpectralConv(BaseSpectralConv):
    ...
    def __init__(
        ...
        # self._contract = get_contract_fun(
        #     self.weight, implementation=implementation, separable=False
        # )
        
        self._contract = get_contract_fun(
            self.weight, implementation="reconstructed", separable=False
        )
...
class SpectralConv1d(SpectralConv):
    ...
    def forward(self, x, indices=0):
        ...
        out_fft[slices] = self._contract(
            x[slices], self.weight[slices], separable=False
        )
...
class SpectralConv2d(SpectralConv):
    ...
    def forward(self, x):
        ...
        # )
        out_fft[slices0] = self._contract(
            x[slices0], self.weight[slices1], separable=False
        )
        ...
        out_fft[slices1] = self._contract(
            x[slices1], self.weight[slices0], separable=False
        )
...
class SpectralConv3d(SpectralConv):
    ...
    def forward(self, x):
        ...
        # )
        out_fft[slices0] = self._contract(
            x[slices0], self.weight[slices3], separable=False
        )
        ...
        # )
        out_fft[slices1] = self._contract(
            x[slices1], self.weight[slices2], separable=False
        )
        ...
        # )
        out_fft[slices2] = self._contract(
            x[slices2], self.weight[slices1], separable=False
        )
        ...
        # )
        out_fft[slices3] = self._contract(
            x[slices3], self.weight[slices0], separable=False
        )
