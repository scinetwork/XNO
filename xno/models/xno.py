...
class XNO(BaseModel, name='XNO'):
    """N-Dimensional Fourier Neural Operator. The XNO learns a mapping between
    spaces of functions discretized over regular grids using different mathematical convolutions, 
    as described in ... .
    
    The key component of an XNO is its SpectralConv layer (see 
...
TXNO = partialclass("TXNO", XNO, factorization="Tucker")
TXNO1d = partialclass("TXNO1d", XNO1d, factorization="Tucker")
TXNO2d = partialclass("TXNO2d", XNO2d, factorization="Tucker")
TXNO3d = partialclass("TXNO3d", XNO3d, factorization="Tucker")
